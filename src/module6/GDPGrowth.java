 ...
 * mapping.
 */
public class GDPGrowth extends PApplet {

	UnfoldingMap map;
	HashMap<String, Float> GDPGrowthMap;
	...
	public void setup() {
		...
		GDPGrowthMap = ParseFeed.loadLifeExpectancyFromCSV(this,"GDP.csv");
	...
	private void shadeCountries() {
		for (Marker marker : countryMarkers) {
			...
			System.out.println(GDPGrowthMap.containsKey(countryId));
			if (GDPGrowthMap.containsKey(countryId)) {
				float lifeExp = GDPGrowthMap.get(countryId);
